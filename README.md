...
**Required software:**
CD-HIT v4.8.1, BLAST v2.16, HMMER v3.4, MAFFT v7.525, TrimAl v1.5, FastTree v2.1.11, and PhyloPyPruner v1.2.6 (These software packages can be installed using conda, and there are no strict version requirements).
