...
TrimAl v1.5
FastTree v2.1.11
PhyloPyPruner v1.2.6
Note: These software packages can be installed using conda, and there are no strict version requirements.

**Required dataset:**
Ref-datasets/NM123/Ref-FASTA
